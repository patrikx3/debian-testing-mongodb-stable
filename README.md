...
The current version is the r4.2.6 build (https://docs.mongodb.com/manual/release-notes/).
...
```bash
sudo ./scripts/build-server.sh r4.2.6
# if you want to specify how many cores you wanna use do like
sudo CORES=4 ./scripts/build-server.sh r4.2.6
```
...
```bash
sudo ./scripts/build-tools.sh r4.2.6
```
...
[**P3X-DOCKER-DEBIAN-TESTING-MONGODB-STABLE**](https://pages.corifeus.com/docker-debian-testing-mongodb-stable) Build v2020.4.131
