[//]: #@corifeus-header
  ...
  [![Build Status](https://travis-ci.org/patrikx3/docker-debian-testing-mongodb-stable.svg?branch=master)](https://travis-ci.org/patrikx3/docker-debian-testing-mongodb-stable) 
...
```bash
sudo ./scripts/build-server.sh r4.0.0
```
...
```bash
sudo ./scripts/build-tools.sh r4.0.0
```
...
[**P3X-DOCKER-DEBIAN-TESTING-MONGODB-STABLE**](https://pages.corifeus.com/docker-debian-testing-mongodb-stable) Build v4.0.10-217 
