...
The current version is the r4.0.4 build (release).
...
```bash
sudo ./scripts/build-server.sh r4.0.4
```
...
```bash
sudo ./scripts/build-tools.sh r4.0.4
```
...
[**P3X-DOCKER-DEBIAN-TESTING-MONGODB-STABLE**](https://pages.corifeus.com/docker-debian-testing-mongodb-stable) Build v2018.11.17-2 
