...
The current version is the r4.0.2 build (release).
...
```bash
sudo ./scripts/build-server.sh r4.0.2
```
...
```bash
sudo ./scripts/build-tools.sh r4.0.2
```
...
[**P3X-DOCKER-DEBIAN-TESTING-MONGODB-STABLE**](https://pages.corifeus.com/docker-debian-testing-mongodb-stable) Build v2018.9.16-2 
