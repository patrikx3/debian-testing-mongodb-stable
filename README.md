...
The current version is the r4.0.8 build (release).
...
```bash
sudo ./scripts/build-server.sh r4.0.8
```
...
```bash
sudo ./scripts/build-tools.sh r4.0.8
```
...
[**P3X-DOCKER-DEBIAN-TESTING-MONGODB-STABLE**](https://pages.corifeus.com/docker-debian-testing-mongodb-stable) Build v2019.4.5 
